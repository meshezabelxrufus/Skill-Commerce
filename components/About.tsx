        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 pt-2 sm:pt-4">
              <div>
                <p className="text-2xl sm:text-3xl font-bold font-display text-foreground">100%</p>
                <p className="text-xs sm:text-sm text-muted-foreground mt-1">U.S. Registered</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold font-display text-foreground">Governed</p>
                <p className="text-xs sm:text-sm text-muted-foreground mt-1">Structured Ops</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold font-display text-foreground">Scalable</p>
                <p className="text-xs sm:text-sm text-muted-foreground mt-1">Infrastructure</p>
              </div>
            </div>
          </div>
        </div>
